<template>
  <div class="box">
    <div class="pb-2">
      <a :href="authStore.facebookLoginUrl" class="fb connect">Sign in with Facebook</a>
    </div>
    <div class="">
      <a :href="authStore.googleLoginUrl" class="sign-in-with-google"><span>Sign in with <strong>Google</strong></span></a>
    </div>
  </div>
</template>
...
export default class AuthForm extends Vue {
  ...
  async mounted () {
    await $token.reset()
    await this.authStore.onMounted()
  }
}
